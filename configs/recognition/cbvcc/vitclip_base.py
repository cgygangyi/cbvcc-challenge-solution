model = dict(
    ...
    cls_head=dict(
        ...
        spatial_type='avg',
        dropout_ratio=0.5),
    test_cfg=dict(average_clips='prob', max_testing_views=5))
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='mmaction2', entity='uw-cbvcc', name='vit_base'))
    ])
...
evaluation = dict(
    ...
    metric_options=dict(
        RecallatTopK=dict(topK_list=(1, ), threshold=0.5, prefix='recall')))
optimizer = dict(
    type='AdamW',
    lr=0.0003,
    betas=(0.9, 0.999),
...
checkpoint = dict(
    ...
    rule='greater',
    max_keep_ckpts=3)
work_dir = './work_dirs/vitclip_base'
